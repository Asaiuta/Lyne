...
fn benchmark_convolver_once(
    ...
    let mut into_conv = FFTConvolver::new(&ir, channels).expect("valid benchmark convolver");
    let mut inplace_conv = FFTConvolver::new(&ir, channels).expect("valid benchmark convolver");
    let mut allocating_conv = FFTConvolver::new(&ir, channels).expect("valid benchmark convolver");
    ...
    let inplace_duration = measure(
        || {
            ...
            inplace_conv
                ...
                .expect("benchmark process_inplace");
