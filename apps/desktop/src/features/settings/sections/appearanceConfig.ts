...
export const SIDEBAR_VISIBILITY_ITEMS: readonly ToggleConfig<keyof SidebarHiddenItems>[] = [
  ...
  { key: "libraryAlbums", itemId: "sidebarHiddenItems.libraryAlbums", labelKey: "settings.appearance.sidebar.libraryAlbums" },
  { key: "libraryArtists", itemId: "sidebarHiddenItems.libraryArtists", labelKey: "settings.appearance.sidebar.libraryArtists" },
  { key: "libraryFolders", itemId: "sidebarHiddenItems.libraryFolders", labelKey: "settings.appearance.sidebar.libraryFolders" },
